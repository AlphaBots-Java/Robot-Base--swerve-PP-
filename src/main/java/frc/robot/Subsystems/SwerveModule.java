...
public class SwerveModule {
    ...
    public SwerveModule(int driveMotorId, int turningMotorId, InvertedValue driveMotorReversed, InvertedValue turningMotorReversed,
        ...
        driverMotorConfigs.Inverted = driveMotorReversed;
        turningMotorConfigs.Inverted = turningMotorReversed;
        
        driveMotor.getConfigurator().apply(driverMotorConfigs);
        turningMotor.getConfigurator().apply(turningMotorConfigs);


        turningPidController = new PIDController(0.33
        , 0.0, 0);
